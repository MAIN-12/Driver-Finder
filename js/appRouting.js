...
function twentyfourHouers(h) {
	return r = (h.amOrPm === 'PM') ? h.hours + 12 : h.hours;
}
function sortRoutes(a, b) {
	return (result = (testHours = twentyfourHouers(a.pickUp) - twentyfourHouers(b.pickUp)) ? testHours : a.pickUp.minutes - b.pickUp.minutes);
}
